...
Orig. Author:     Ji-Sung Kim, Evan Chow
Orig. Project:    deepjazz, jazzml

Code adapted from Ji-Sung Kim's deepjazz, https://github.com/jisungk/deepjazz,
and Evan Chow's jazzml, https://github.com/evancchow/jazzml, with permission.
'''
